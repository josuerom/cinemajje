...
@endphp  
          ...
          <tr>
            ...
            <td>
             ...
             <h4 class="alert-heading">Pago efectuado correctamente, son $<?php echo number_format($final , 2); echo("0 COP");?>, <strong> Ticket generado ,</strong>
              <br> <?php
              echo  $ticket  ;
              echo "<br>";
						...
						<div class="col-lg-4 footer_col">
							<div class="footer_about">
								...
								<div class="footer_about_text">
									<p>Todas las películas de cartelera y los horarios del CinemaJJE</p>
								</div>
							</div>
						</div>
